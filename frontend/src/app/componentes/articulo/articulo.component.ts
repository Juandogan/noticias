...
export class ArticuloComponent implements OnInit, OnDestroy {
    ...
    this.ruta.data.subscribe((data) => {
      ...
      if (this.nota[0].art1) {
        ...
        this.crudService.getCategorias(this.crudService.unArticulo.categoria).subscribe(res => {
          var aux = res
          console.log(aux, "porfavor")
          this.dataRelacionado = this.randomNoRepeat(aux);
          console.log(this.dataRelacionado, 'antes de pasar')
  ...
  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;};">
   ...
   margin-bottom:10px;
    ...
    aux2 = aux2.split('style="text-align:center;"').join('style="text-align:center!important; font-size:15px!important; margin-top:-10px!important; margin-bottom:30px!important;"')
